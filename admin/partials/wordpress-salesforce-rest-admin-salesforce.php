<div class="wrap">
    ...
    <?php if ( !$is_authorized && SALESFORCE_CONSUMER_KEY !== '' && SALESFORCE_CONSUMER_SECRET !== '' && SALESFORCE_CALLBACK_URL !== '' && SALESFORCE_LOGIN_BASE_URL !== '') { ?>
    ...
    <p class="submit">
    	<a href="<?php echo $auth_url; ?>" class="button button-primary">Log in with Salesforce</a>
    </p>
    <?php } else if ( $is_authorized ) { ?>
		<div>
		<?php
