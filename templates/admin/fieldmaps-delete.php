<?php
/**
 * The form to delete fieldmaps, which map a WordPress and Salesforce object type together.
 *
...
<form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>">
	...
	<p>
		...
		echo sprintf(
			...
			esc_html__( 'This fieldmap is called %1$s and it maps the Salesforce %2$s object to the WordPress %3$s object.', 'object-sync-for-salesforce' ),
